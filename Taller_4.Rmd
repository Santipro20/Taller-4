...
ggplot(data = base_completa, 
       mapping = aes(x= IHSM,color = IncomeGroup)) + 
...
ggplot(data = base_completa, 
  ...
  labs(title = "Entre menor es el GINI", subtitle = "mayor es el Indice Humano de Salud Mental", x = "Indice Humano de Salud Mental", y = "GINI despues de impuestos", caption = "Produccion Propia", color= "Grupo de Ingreso")+
  theme_classic()
...
ggplot(data = base_completa, 
       mapping = aes(x = IHSM_ajustado,
                     y = IC)) +
  geom_point(aes(color= IncomeGroup))+
     geom_smooth(method = "lm",aes(color= IncomeGroup))+
